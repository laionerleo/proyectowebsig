        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="row">
                        <div class="col-md-12">
                            <h1>MICROS</h1>
                              <a class="btn btn-primary" href="<?=$url  ?>micros/vistacrear/0">crear micro</a>
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table class="table datatable">
                                            ...
                                            <tbody>
                                            <?php for ($i=0; $i < count($micros) ; $i++) {
                                                    # code...
                                                 ?>
                                                 <tr>
                                                    <td><?php echo $i ?></td>
                                                    <td><?php echo $micros[$i]->mic_nrointerno ?></td>
                                                    <td><?php echo $micros[$i]->mic_placa ?></td>
                                                    <td><?php echo $micros[$i]->mic_modelo ?></td>
                                                    <td><?php echo $micros[$i]->mic_estado ?></td>
