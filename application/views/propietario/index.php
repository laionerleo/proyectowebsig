        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="row">
                        <div class="col-md-12">
                            <h1>PROPIETARIOS</h1>
                              <a class="btn btn-primary" href="<?=$url  ?>propietarios/vistacrear/0">crear propietario</a>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table datatable">
                                            ...
                                            <?php for ($i=0; $i < count($propietarios) ; $i++) {
                                                 ...
                                                 <tr>
                                                    <td><?php echo $i ?></td>
                                                    <td><?php echo $propietarios[$i]->pro_nombrecompleto ?></td>
                                                    <td><?php echo $propietarios[$i]->pro_celular ?></td>
                                                    <td><?php echo $propietarios[$i]->pro_ci ?></td>
                                                    <td><?php echo $propietarios[$i]->pro_direccion ?></td>
